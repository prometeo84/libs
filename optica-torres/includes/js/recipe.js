...
$(document).ready(function () {
  ...
  var mirror = $('<div id="autocomplete-mirror"></div>')
    .css({
      position: "absolute",
  ...
  function setupAutocomplete(selector, catalogName) {
    ...
    $(selector)
      ...
      .autocomplete({
        ...
        open: function () {
          ...
          $widget.position({
            ...
            at:
              ...
              coords.left +
              " top+" +
              (coords.top + parseInt($input.css("font-size"), 10) + 2),
          });
        ...
        focus: function () {
          // Previene que se inserte el valor al enfocar un item con el ratón
